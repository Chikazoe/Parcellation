...
for ith = 1:length(threshperc)
    labels_path = strcat('../../results/parcel_creator/L/L_',num2str(threshperc(ith)),'.func.gii')
    ...
    for i=1:length(label_cell)
       ...
       NEW_ROI_LEFT(indeies) = i;
    end

    save_path = '../../results/parcellation/ours_roi/L';
    save([save_path, '/NEW_ROI_LEFT_th',num2str(threshperc(ith)),'.mat'], 'NEW_ROI_LEFT')
