...
%location of surface node neighbors file from caret -surface-topology-neighbors
neighborsfile = '/home/chikazoe/nishiyama/parcellation-nishiyama/src/gordon_data/node_neighbors.txt';

%location of a binary metric file with ones in the medial wall
medial_maskfile = ['/home/chikazoe/nishiyama/parcellation-nishiyama/src/gordon_data/medial_wall.' hem '.32k_fs_LR.func.gii'];

%location of a binary metric file with zeros in a slightly eroded medial wall
eroded_medial_maskfile = ['/home/chikazoe/nishiyama/parcellation-nishiyama/src/gordon_data/' hem '.atlasroi_erode3.32k_fs_LR.shape.gii'];
...
metric(logical(erodedmedialmaskdata)) = 100000;
...
save(gifti(label),[output_filestem '/' hem '_' num2str(round(threshperc*100)/100) '.func.gii']);
